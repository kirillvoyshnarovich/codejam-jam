...
(function Motifications()  {
    class Notifications {
        ...
        createNotification() {
            ...
            const close = this.createElement('button', {class:'notifications__close'})
    ...
    class Carusel {
        ...
        handlerButton(button) {
            let handler = (e)=> {
                ...
                }else if(e.target.classList.contains('notifications__control--button-right') || e.keyCode == 39) {
...
var data = ['More than 60% of emails we send do not require a response. Use "No response needed" to make sure recipients know that a response is unnecessary.',
